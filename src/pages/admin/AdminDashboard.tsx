...
import { 
  ...
  Sparkles, Megaphone, CheckCircle, Smartphone
} from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-3xl font-black tracking-tight flex items-center gap-3">
            <LayoutDashboard className="w-8 h-8 text-rose-600" /> Admin Command Center
          </h1>
          <p className="text-neutral-400 text-sm">Real-time statistics, promotion triggers, and live system logs</p>
        </div>
        <div className="flex items-center gap-3">
          <Link to="/admin/videos" className="flex items-center gap-2 px-6 py-3 bg-rose-600 hover:bg-rose-700 rounded-full font-bold transition-all text-xs uppercase tracking-wider shadow-xl shadow-rose-600/20">
            <Plus className="w-4 h-4" /> Add Streaming Video
          </Link>
          <Link to="/admin/settings" className="p-3 bg-neutral-900 border border-white/5 rounded-full hover:bg-neutral-850 text-neutral-400 hover:text-white transition-colors">
